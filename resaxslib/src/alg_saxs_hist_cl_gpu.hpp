...
#ifndef RE_ALG_SAXS_HIST_CL_GPU_HPP
#define RE_ALG_SAXS_HIST_CL_GPU_HPP
...
namespace algorithm {
    ...
    class saxs_hist_cl_gpu : public i_saxs<FLT_T, cl_base<FLT_T>>
    {
        ...
        public:
            atomic_ff_params(saxs_hist_cl_gpu &owner, std::function<void(const form_factor_params<FLT_T> &)> exp_factor_changed_sink) :
        ...
        public:
            gpu_pt_wf_params(saxs_hist_cl_gpu &owner);
...
#endif // RE_ALG_SAXS_HIST_CL_GPU_HPP
